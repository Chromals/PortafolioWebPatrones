...
public class ReporteController {
    ...
    public ResponseEntity<Resource> categoriaproducto(@RequestParam String tipo) throws IOException
    {
        return reporteService.generaReporte("categoriaproducto", null, tipo);
    }
}
